...
public class PlayerTopControl extends FrameLayout {
    ...
    public void setShareIconOnClick(OnClickListener lis){
        findViewById(R.id.share_icon).setVisibility(VISIBLE);
        findViewById(R.id.share_icon).setOnClickListener(lis);
    }
